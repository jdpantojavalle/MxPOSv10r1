<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/GreenPasture/GreenPasture.Master" AutoEventWireup="true" CodeBehind="PaginaDomicilio.aspx.cs" Inherits="MxPOS10.Sistema.Paginas.PaginaDomicilio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:Label ID="Label1" runat="server" 
            ...
            Text="Receptor seleccionado"></asp:Label>
    </div>
    <table style="width:100%;">
        ...
        <tr>
            <td class="style2">
                <asp:Label ID="lblIDReceptor" runat="server" CssClass="style4" 
                    Text="lblIDReceptor"></asp:Label>
            </td>
            <td class="style3">
                <asp:Label ID="lblRFCReceptor" runat="server" CssClass="style4" 
                    Text="lblRFCReceptor"></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblNombreReceptor" runat="server" CssClass="style4" 
                    Text="lblNombreReceptor"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2">
